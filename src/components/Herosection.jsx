...
// import data from '../json/fetchData'; // adjust path if needed
// import { FaChevronLeft, FaChevronRight } from 'react-icons/fa';
// const HeroSection = () => {
//   const [currentIndex, setCurrentIndex] = useState(0);
//   const heroSlides = data["1"].slides;
...
//       <button onClick={handlePreviousClick} className="hero-button prev"> <FaChevronLeft /></button>
...
//       <button onClick={handleNextClick} className="hero-button next"> <FaChevronRight /></button>
//     </div>
//   );
// };
